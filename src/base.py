...
class BaseRepository:
    ...
    async def bulk_create(self, instances: Iterable[object], session: AsyncSession):
    ...
    async def update(self, instance: object, session: AsyncSession):
        await session.merge(instance)
        await session.commit()
        return instance

    async def bulk_update(self, instances: Iterable[object], session: AsyncSession):
    ...
    async def bulk_delete(self, instances: Iterable[object], session: AsyncSession):
        for instance in instances:
            await session.delete(instance)
        await session.commit()
